...
type FourPlaceholdersProps = ComponentProps & {

}

// const FourPlaceholders = ({ rendering}: FourPlaceholdersProps): JSX.Element => {
//   return (
...
//           </div>
//           <div className="col-lg-3 col-md-6 col-12">
//             <Placeholder name="jss-base-content-4"
//               rendering={rendering}
//               renderEach={(component, index) => <div key={index}>{component}</div>}
//               renderEmpty={(components) => <div>{components}</div>}
//             />
...
const FourPlaceholders = ({ rendering}: FourPlaceholdersProps): JSX.Element => {
  return (
    <div className="fun-factor-area fun-bg-img">
      <div className="container">
        <div className="row">
          <div className="col-lg-3 col-md-6 col-12 single-fun-factor">
            <Placeholder name="jss-base-content-1"
              rendering={rendering}
            />
          </div>
...
export default FourPlaceholders;
